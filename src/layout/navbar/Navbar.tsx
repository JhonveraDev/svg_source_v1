    ...
    <div className="navbar">
      <div className="navbar__icons">
        ...
        <div className="navbar__search">
          <div className="navbar__theme navbar__icon-btn">
          ...
          <div className="navbar__social navbar__icon-btn">
          ...
          <div className="navbar__github navbar__icon-btn">
          ...
          <div className="navbar__divider"></div>
          <div className="navbar__submit navbar__icon-btn">
