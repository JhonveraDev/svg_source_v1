    ...
    <div className="navbar">
      <div className="navbar__icons">
        ...
        <div className="navbar__search">
          <div className="navbar__theme navbar__icon-btn" title="Mode Toogle">
          ...
          <div className="navbar__cv navbar__icon-btn" title="CV">
          ...
          <div className="navbar__social navbar__icon-btn" title="Linkedin - Jhon Vera">
          ...
          <div className="navbar__github navbar__icon-btn" title="Github - JhonveraDev">
          ...
          <div className="navbar__submit navbar__icon-btn" title="Whatsapp">
